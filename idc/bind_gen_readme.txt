...
生成 int_distributor_sva 实例 (每ic编号一个实例)
...
实例化ic_number个int_distributor_sva
*_idc_wrap.v的输入直接bind到全部的int_distributor_sva上，由于这部分代码重复，将其定义为宏，应用到每个int_distributor_sva上
*_idc_wrap.v的输输出根据ic_number bind到对应的int_distributor_sva上
